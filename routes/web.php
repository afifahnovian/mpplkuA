...
Route::get('/user/register','App\Http\Controllers\SuratPengunduranDiriController@create');
Route::post('/user/register', 'App\Http\Controllers\SuratPengunduranDiriController@store')->name('user-surat-pengunduran-diri');
