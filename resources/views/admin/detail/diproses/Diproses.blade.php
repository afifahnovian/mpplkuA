...
<label><h1><span class="badge label-table badge-warning">Diproses</span></h1></label>

</div>
  </div>

<div> 
   <label class="col" for="suratpengantardept"><h3>Unggah Berkas</h3></label>
</div>

<div class="row">
    <div class="col">
            <input style="max-width: 40rem;" type="file" id="suratpengantardept" class="form-control" placeholder=".pdf">
    </div>
    <div class="col">
